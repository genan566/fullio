...
const CardNFT1 = () => {
    return (
        ...
        <div className="rounded-xl p-4 py-3 w-[300px] shadow-lg bg-white border border-gray-900">
            <div className="flex gap-2 row mt-3 items-center justify-start w-fit " >
                <img
                    ...
                    alt="user Profile" />
                <div className="">
                    <p className="text-[.9rem] text-black font-MontBold">Jean Gontran</p>
            ...
            <div className="flex justify-between gap-1 items-center mt-[1rem]">
                <p className="text-[.9rem] text-black font-MontBold">Explosion Closure</p>
                <p className="text-[.75rem] text-zinc-500 font-MontBold">2.1</p>
            </div>

            <div className="flex justify-between gap-1 items-center mt-[.8rem]">
                <p className="text-[.9rem]  text-black font-MontBold">Price ETH</p>
                <p className="text-[.75rem] text-black font-MontBold">2.55</p>
            </div>
        </div>
    )
}
