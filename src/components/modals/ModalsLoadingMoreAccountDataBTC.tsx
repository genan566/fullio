...
const ModalsLoadingMoreAccountDataWalletBTC = () => {

    const userTokenContext = React.useContext(RootUserTokenContext)
    const { showModalForLoadingMoreWalletBTC } = useAppSelector((state: RootState) => state.modalsReducer)
    ...
    const handleSuscribeToSale = (gettedData: UserTypesValues) => {
        ...
        if (!Boolean(userContext.user.id)) {
            ...
            resetField("account_balance_btc")
        }
        else {
    ...
    // }, [showModalForLoadingMoreWalletBTC])
                        ...
                        <div className="cModals">
                            ...
                            <div className="cModals-container p0">
                                ...
                                <div className="min-[800px]:px-[2rem] px-[1rem] w-full mb-[1rem]">
                                    ...
                                    mb-2 pb-[1rem] text-center border-b w-full border-slate-700">Loading More BTC balance</h2>
                                </div>
...
export default ModalsLoadingMoreAccountDataWalletBTC